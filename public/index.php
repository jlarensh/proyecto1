<?php
    ...
    $app->get('/dashboard/?', function () use ($app) {    
          ...
          return $controller->pageDashboard();
    });
    ...
    $app->get('/forms/actas/?', function () use ($app) {    
          $controller = new UF\GroupController($app);
          return $controller->pageActas();
    });

    $app->post('/forms/actas/?', function () use ($app) {    
          $controller = new UF\GroupController($app);
          return $controller->createActa();
    });

    /********** MINUTAS DEMO PAGE **********/

    $app->get('/forms/minutas/?', function () use ($app) {    
          $controller = new UF\GroupController($app);
          return $controller->pageMinutas1();
    });

    $app->post('/forms/minutas/?', function () use ($app) {    
          $controller = new UF\GroupController($app);
          return $controller->createMinutas1();
    });
