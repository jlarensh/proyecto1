...
$table_actas = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "actas", [
    "makedate",
    "cianame",
    "ciatype",
    "celebdate",
...
$table_minutas1 = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "minutas1", [
    "id",
    "urb",
    "ph",
    "alicuota",
...
\UserFrosting\Database::setSchemaTable("actas", $table_actas);
\UserFrosting\Database::setSchemaTable("minutas1", $table_minutas1);
